...
# Physics Attention module (from Transolver)
class Physics_Attention_Irregular_Mesh(nn.Module):
    """Physics Attention for irregular meshes - does not use edge information"""
    ...
    def forward(self, x):
        # x: Only receives (B, N, C) format, does not use edge information
        B, N, C = x.shape
